      ...
      <Card elevation={4}>
        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
          <Box display="flex" flexDirection="column" alignItems="center">
            <PersonAddAlt1Icon sx={{ fontSize: { xs: 32, sm: 40 }, mb: 1, color: '#111', border: '2px solid #111', borderRadius: '50%', p: 0.5 }} />
            ...
            {/* Add login prompt below register form */}
            <Box sx={{ mt: 2, textAlign: 'center' }}>
              <Typography variant="body2" align="center" sx={{ mt: 2 }}>
                Already have an account?{' '}
                <a href="/login" style={{ color: '#111', textDecoration: 'underline', fontWeight: 600 }}>Login here</a>
              </Typography>
            </Box>
            <Snackbar
              open={showHint}
